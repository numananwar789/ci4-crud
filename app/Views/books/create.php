            ...
            <div class="col-md-12 mt-4">
                <div class="card">
                    <div class="card-header bg_color">
                        <div class="card-header-title text-white"> Create Book </div>
                    </div>
                    <div class="card-body">
                        <form name="createForm" id="createForm" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" placeholder="ISBN No" name="isbn_no" id="isbn_no" class="form-control" value="<?php echo set_value('isbn_no') ?>">
                            </div>
